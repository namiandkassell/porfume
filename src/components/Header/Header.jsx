  ...
  return (
    <header className="header">
      ...
      <div className="header_logo">
        <img src={ogo} alt="adadwawd" />
      </div>
      <div className="header_icons">
        <NavLink>
          <img src={lupa_zalupa} alt="zalupa" />
        </NavLink>
        <NavLink className="headernav-link" to="/register">
          <img src={logo_icon} alt="xd" />
        </NavLink>
        <NavLink>
          <img src={favorites} alt="serdce" />
        </NavLink>
        <NavLink to={"/cart"}>
          <img src={cart} alt="korzina" />
        </NavLink>
      </div>
    </header>
  );
